...
// Source: openclaw/src/agents/embedded-agent-runner/run/attempt.bootstrap-context.ts
// Lines: 1-55
// impl Agent: see AGENTS.md — bootstrap context file injection into prompt
